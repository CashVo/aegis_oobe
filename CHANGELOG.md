...
- `aegis install` bootstrap phase — Fixed issue where bootstrap failed if identity store already contained tenants from previous runs. The install now works correctly on fresh systems.
